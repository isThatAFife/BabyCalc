...
def main():
    ...
    while True:
        ...
        print(
            f"""Your baby needs {formula_amount_ml:.2f} 
millilitres of formula per day\n"""
             )
        ...
        print(
            f"""Since the last entry, 
your baby's age has changed by {age_change_weeks:.2f} weeks 
and their weight has changed by {weight_change_kg:.2f} kilograms.\n"""
             )
